<div class="sidebar border-end">
            ...
            <ul class="nav flex-column">
                ...
                <li>
                    <a class="nav-link" href="../Faculty/update-data.php">
                        <i class="bi bi-database-fill-add"></i> Update Data
                    </a>
                </li>
                <li>
                    <a class="nav-link" href="../Faculty/campus-drive.php">
                        <i class="bi bi-cloud-arrow-down-fill"></i> Campus Drive
                    </a>
                </li>
                <li>
                    <a class="nav-link" href="../Faculty/view-data.php">
                ...
                <li>
                    <a class="nav-link" href="../Faculty/faculty-password.php">
                        <i class="bi bi bi-gear-fill"></i> Manage Account
                    </a>
                </li>
            </ul>
        </div>